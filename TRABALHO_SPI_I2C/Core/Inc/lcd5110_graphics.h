...
void desenharSeta(Direcao dir); // desenhar seta no display
void mostrarResultado(uint8_t acertou); // mostrar se o usuário acertou ou errou
void mostrarTelaInicial(void); // mostrar a tela inicial do jogo
